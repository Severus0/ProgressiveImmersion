...
browser.storage.local.get( 'updateFrequency' ).then( ( value ) => {
	document.getElementById( 'updateFrequency' ).value = value.updateFrequency ?? DEFAULT_UPDATE_FREQUENCY;
...
browser.storage.local.get( 'minWordLength' ).then( ( value ) => {
	document.getElementById( 'minWordLength' ).value = value.minWordLength ?? DEFAULT_MIN_WORD_LENGTH;
...
browser.storage.local.get( 'wordsToSave' ).then( ( value ) => {
	document.getElementById( 'wordsToSave' ).value = value.wordsToSave ?? DEFAULT_WORDS_TO_SAVE;
...
browser.storage.local.get( 'filterMaxShareOfWords' ).then( ( value ) => {
	document.getElementById( 'filterMaxShareOfWords' ).value = value.filterMaxShareOfWords ?? DEFAULT_FILTER_MAX_SHARE_OF_WORDS;
...
browser.storage.local.get( 'filterMinShareOfWords' ).then( ( value ) => {
	document.getElementById( 'filterMinShareOfWords' ).value = value.filterMinShareOfWords ?? DEFAULT_FILTER_MIN_SHARE_OF_WORDS;
